...
const LegalNotice = () => (
  <CompanyPageLayout title="Legal Notice" description="Legal operator and registered-office information for the CeladonChina website." path="/legal-notice" eyebrow="Legal information" icon={Scale}>
