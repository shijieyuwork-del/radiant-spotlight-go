...
const Terms = () => (
  <CompanyPageLayout title="Terms of Use" description="The terms that apply when you use Sino Aesthetics information, consultation and travel-coordination services." path="/terms" eyebrow="Terms" icon={FileText}>
    <section className="rounded-[2rem] border border-border bg-card p-6 shadow-soft md:p-9">
      <h2 className="font-display text-2xl font-semibold tracking-tight md:text-3xl">Using Sino Aesthetics</h2>
      <div className="mt-4 space-y-4 text-sm leading-7 text-muted-foreground md:text-base">
        <p>Sino Aesthetics provides general information and non-clinical coordination support. It is not a hospital, clinic, medical practice, or emergency service and does not provide diagnosis, prescriptions, or medical treatment.</p>
