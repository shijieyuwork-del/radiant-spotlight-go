...
const About = () => {
  ...
  const questions = [
    {
      question: "What is Sino Aesthetics?",
      answer: "Sino Aesthetics is a China-focused cosmetic medical travel information and non-clinical coordination platform for international patients considering cosmetic care in China.",
    },
    {
      question: "Does Sino Aesthetics provide medical treatment or medical advice?",
      answer: "No. Sino Aesthetics is not a hospital, clinic or medical practice. It does not diagnose, prescribe, select a procedure for a patient, control clinical care or guarantee an outcome.",
    },
    {
      question: "How can Sino Aesthetics help an international patient?",
      answer: "Sino Aesthetics can help people compare published provider and procedure information, prepare consultation questions, organize records, and coordinate appointments, translation and practical travel support when confirmed.",
    },
    {
    ...
    {
      question: "Why do clinics work with Sino Aesthetics?",
      answer: "Sino Aesthetics helps partner clinics communicate with international patients and coordinates non-clinical details such as introductions, consultations, appointments, interpretation, airport pickup and accommodation. The clinic remains responsible for medical care and receives medical payments directly from the patient.",
    },
  ];
  ...
  return (
    <>
      ...
      <TrustPageLayout
        ...
        eyebrow="About Sino Aesthetics"
        icon={HeartHandshake}
        title="A clearer way to prepare for cosmetic care in China."
        intro="Sino Aesthetics brings provider information, practical questions, and travel coordination into one place, so you can prepare before making a medical decision."
      >
        <TrustSection id="clinic-partnerships" title="Why clinics work with Sino Aesthetics">
          ...
          <div className="grid gap-4 pt-2 lg:grid-cols-2">
            ...
            <div className="rounded-2xl border border-border bg-muted/35 p-5">
              ...
              <p className="mt-3">You choose the provider and pay all consultation, examination, surgery, anesthesia and other medical fees directly to that hospital or clinic. Sino Aesthetics does not collect medical payments or control clinical decisions.</p>
        ...
        <TrustSection title="Sino Aesthetics at a glance">
          <dl className="grid gap-4 sm:grid-cols-2">
            {[
              ...
              ["Who delivers care", "Independent treating clinicians and licensed medical facilities—not Sino Aesthetics."],
              ["How to contact us", "Email contact@sinoaesthetics.com or use WhatsApp at +1 470 861 3825."],
            ].map(([term, detail]) => (
        ...
        <TrustSection title="Where our role ends">
          <p>Sino Aesthetics is not a hospital, clinic, medical practice, or emergency service. We do not diagnose, prescribe, select a procedure for you, control clinical care, or guarantee an outcome.</p>
        ...
        <TrustSection title="Contact and accountability">
          <p>Questions about a profile, a policy, or a correction can be sent to <a className="font-semibold text-foreground underline decoration-primary/50 underline-offset-4" href="mailto:contact@sinoaesthetics.com">contact@sinoaesthetics.com</a>. For travel coordination, you can also contact us on WhatsApp at <a className="font-semibold text-foreground underline decoration-primary/50 underline-offset-4" href="https://wa.me/14708613825">+1 470 861 3825</a>.</p>
        </TrustSection>
      </TrustPageLayout>
    </>
  );
