        ...
        <div className="container relative py-16 md:py-24">
          <div className="max-w-3xl space-y-5">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl">
              Every review is tied to a real, verified procedure booked through CeladonChina — with cross-border travel details, recovery scores, and before/after photos uploaded by patients themselves.
            </p>
