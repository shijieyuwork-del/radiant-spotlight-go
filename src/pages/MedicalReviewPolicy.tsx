  ...
  <>
    ...
    >
      <TrustSection title="When we use the words medically reviewed">
        ...
        <p>If those details are absent, the page should be treated as editorially researched information, not medically reviewed content. Sino Aesthetics does not use a general disclaimer as a substitute for named clinical review.</p>
      </TrustSection>
      ...
      <TrustSection title="Not personal medical advice">
        ...
        <p>If you may be experiencing a medical emergency or a serious complication, contact local emergency services or the treating facility immediately. Do not wait for a reply from Sino Aesthetics.</p>
      </TrustSection>
    </TrustPageLayout>
  </>
);
