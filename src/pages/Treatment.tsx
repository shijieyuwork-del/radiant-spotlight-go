...
const Treatment = () => {
  ...
  const reviews = [
    ...
    { name: "Mei L.", age: 24, text: "Watched her recovery diary on CeladonChina before flying to Seoul. Everything matched — same results, same surgeon, same kindness. No surprises.", rating: 5 },
