...
const koreaRhino: DestinationData = {
  ...
  faq: [
    { q: "Is rhinoplasty in Korea safe for international patients?", a: "Korean Society of Plastic & Reconstructive Surgeons (KSPRS) board certification is mandatory for every expert on Sino Aesthetics. All clinics are JCI-accredited or Korean MOHW-licensed." },
    ...
    { q: "What if I'm not happy with the result?", a: "Sino Aesthetics mediates revision policies. Most Seoul clinics offer free revision within 12 months if outcomes don't match the agreed simulation." },
