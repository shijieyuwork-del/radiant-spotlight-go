...
const dict: Record<AsiaLang, Dict> = {
  en: {
    ...
    "hero.subtitle": "10k+ verified before-after diaries · 300+ top-tier surgeons across China · English-speaking coordinators, airport pickup & medical visa support included.",
    ...
    "tx.titleEm": "procedures in China",
    ...
    "cases.wallTitleMain": "Real cases · ",
    "cases.wallTitleEm": "TikTok-style wall",
  ...
  zh: {
    ...
    "cases.wallTitleMain": "真实案例 · ",
    "cases.wallTitleEm": "TikTok 视频墙",
