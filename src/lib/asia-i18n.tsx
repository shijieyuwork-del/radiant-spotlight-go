...
const dict: Record<AsiaLang, Dict> = {
  en: {
    ...
    "experts.kicker": "Attending surgeons",
    "experts.title1": "Review surgeon credentials",
    "experts.titleEm": "before you choose",
    "experts.lic": "Medical license:",
    "experts.exp": "yrs experience",
    "experts.cases": "procedures",
    "experts.cta": "View profile",
  ...
  zh: {
    ...
    "cl.cta": "在线咨询 · 免费面诊",
    "experts.kicker": "主诊专家",
    "experts.title1": "选择专家前，",
    "experts.titleEm": "先了解资质",
    "experts.lic": "执业证书：",
    "experts.exp": "年从业经验",
    "experts.cases": "手术案例",
    "experts.cta": "查看专家档案",
  ...
  ru: {
    ...
    "experts.kicker": "Оперирующие хирурги",
    "experts.title1": "Каждый хирург ·",
    "experts.titleEm": "лицензия на руках",
    "experts.lic": "Медицинская лицензия:",
    "experts.exp": "лет опыта",
    "experts.cases": "процедур",
    "experts.cta": "Открыть профиль",
