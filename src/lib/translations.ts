...
export type TranslationKey =
  | "nav.discover" | "nav.treatments" | "nav.reviews" | "nav.forClinics" | "nav.signIn" | "nav.signUp"
...
const en: Record<TranslationKey, string> = {
  "nav.discover": "Discover", "nav.treatments": "Treatments", "nav.reviews": "Reviews", "nav.forClinics": "For Clinics", "nav.signIn": "Sign in", "nav.signUp": "Sign up",
  ...
  "social.verifiedDoctors": "Verified experts", "social.countriesCovered": "Countries covered",
  ...
  "doctor.pill": "Expert profile", "doctor.titlePre": "Every credential,", "doctor.titleEm": "on the record.",
...
const ko: Record<TranslationKey, string> = {
  "nav.discover": "둘러보기", "nav.treatments": "시술", "nav.reviews": "후기", "nav.forClinics": "병원 입점", "nav.signIn": "로그인", "nav.signUp": "회원가입",
  "hero.badge": "검증된 외과의 4,200명 이상 · 50개국 이상",
  "hero.title1": "전 세계", "hero.titleEm": "최고의", "hero.title2": "성형외과 전문가를 만나세요.",
  "hero.subtitle": "검증된 전문가. 진짜 결과. 50개국 이상. 신뢰할 수 있는 글로벌 성형 플랫폼 — 보드 인증 자격, 실제 회복 일기, 투명한 가격.",
  "hero.procedure": "시술", "hero.procedurePlaceholder": "코, 쌍꺼풀...",
  "hero.country": "국가", "hero.findDoctorsIn": "전문가 찾기:", "hero.featuredIn": "추천 시술:",
  "hero.boardCertified": "보드 인증 전문가만", "hero.countries": "50개국 이상", "hero.diaries": "회복 일기 200만+",
  "social.verifiedDoctors": "검증된 전문가", "social.countriesCovered": "지원 국가",
  ...
  "clinics.pill": "인증됨", "clinics.titlePre": "여성들이 진짜로", "clinics.titleEm": "신뢰하는 전문가.", "clinics.viewClinic": "병원 보기",
  "doctor.pill": "전문가 프로필", "doctor.titlePre": "모든 자격을", "doctor.titleEm": "투명하게.",
  "doctor.desc": "면허, 보드 인증, 수술 건수, 언어, 병원 제휴 — 모든 전문가가 사전 검증됩니다.",
  ...
  "how.consult": "상담", "how.consultDesc": "보드 인증 전문가와 무료 화상 상담. 견적 비교.",
  "how.fly": "방문 & 수술", "how.flyDesc": "여행 패키지, 회복 호텔, 한국어 코디네이터 포함.",
  "cta.pill": "전문가용", "cta.titlePre": "당신의 진료를", "cta.titleEm": "수백만 명에게.",
  "cta.desc": "4,200곳 이상의 보드 인증 성형 클리닉에 합류하세요. 환자 일기로 작품을 보여주고, 국제 환자를 유치하세요.",
  "cta.apply": "입점 신청",
};

const zh: Record<TranslationKey, string> = {
  "nav.discover": "发现", "nav.treatments": "项目", "nav.reviews": "评价", "nav.forClinics": "诊所入驻", "nav.signIn": "登录", "nav.signUp": "注册",
  ...
  "hero.country": "国家", "hero.findDoctorsIn": "查找专家:", "hero.featuredIn": "热门推荐:",
  "hero.boardCertified": "仅限认证专家", "hero.countries": "50+ 国家", "hero.diaries": "200万+ 恢复日记",
  "social.verifiedDoctors": "认证专家", "social.countriesCovered": "覆盖国家",
  ...
  "clinics.pill": "认证", "clinics.titlePre": "女生们真正", "clinics.titleEm": "信赖的专家。", "clinics.viewClinic": "查看诊所",
  "doctor.pill": "专家档案", "doctor.titlePre": "每项资质,", "doctor.titleEm": "公开透明。",
  "doctor.desc": "执照、专科认证、手术量、语言、医院隶属 — 所有专家上线前均经过验证。",
...
const th: Record<TranslationKey, string> = {
  "nav.discover": "ค้นพบ", "nav.treatments": "หัตถการ", "nav.reviews": "รีวิว", "nav.forClinics": "สำหรับคลินิก", "nav.signIn": "เข้าสู่ระบบ", "nav.signUp": "สมัครสมาชิก",
  ...
  "hero.country": "ประเทศ", "hero.findDoctorsIn": "หาผู้เชี่ยวชาญใน", "hero.featuredIn": "แนะนำใน",
  "hero.boardCertified": "เฉพาะที่ผ่านการรับรอง", "hero.countries": "50+ ประเทศ", "hero.diaries": "บันทึกฟื้นตัว 2 ล้าน+",
  "social.verifiedDoctors": "ผู้เชี่ยวชาญที่ตรวจสอบแล้ว", "social.countriesCovered": "ประเทศที่ครอบคลุม",
  ...
  "doctor.pill": "โปรไฟล์ผู้เชี่ยวชาญ", "doctor.titlePre": "ทุกคุณวุฒิ,", "doctor.titleEm": "เปิดเผย",
...
const ar: Record<TranslationKey, string> = {
  "nav.discover": "اكتشف", "nav.treatments": "الإجراءات", "nav.reviews": "التقييمات", "nav.forClinics": "للعيادات", "nav.signIn": "تسجيل الدخول", "nav.signUp": "إنشاء حساب",
  ...
  "doctor.pill": "ملف الخبير", "doctor.titlePre": "كل المؤهلات,", "doctor.titleEm": "موثقة وعلنية.",
