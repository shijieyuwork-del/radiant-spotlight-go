...
const en: Record<TranslationKey, string> = {
  ...
  "expert.desc": "License, board certs, case volume, languages, hospital affiliations — verified before any expert goes live.",
...
const ko: Record<TranslationKey, string> = {
  ...
  "expert.desc": "면허, 보드 인증, 수술 건수, 언어, 병원 제휴 — 모든 의사가 사전 검증됩니다.",
...
const zh: Record<TranslationKey, string> = {
  ...
  "expert.desc": "执照、专科认证、手术量、语言、医院隶属 — 所有专家上线前均经过验证。",
...
const th: Record<TranslationKey, string> = {
  ...
  "expert.desc": "ใบอนุญาต, การรับรอง, จำนวนเคส, ภาษา, โรงพยาบาลในเครือ — ตรวจสอบทุกคน",
...
const ar: Record<TranslationKey, string> = {
  ...
  "expert.desc": "الترخيص، الشهادات، عدد العمليات، اللغات، المستشفيات — يتم التحقق قبل ظهور أي طبيب.",
