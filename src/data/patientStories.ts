...
export const patientStories: PatientStory[] = [
  {
    ...
    story: [
      "I had always wanted to visit China, and Sino Aesthetics helped me combine that trip with rhinoplasty, double-eyelid surgery and lip enhancement.",
    ...
    storyZh: [
      "我一直想去中国旅行，Sino Aesthetics 帮我把这趟旅程与隆鼻、双眼皮和丰唇项目安排在一起。",
  ...
  },
  {
    ...
    country: "Canada",
    countryZh: "加拿大",
    excerpt: "Sino Aesthetics introduced me to several established clinic groups, so I could compare options by budget and priorities.",
    excerptZh: "Sino Aesthetics 推荐了几家成熟的连锁植发机构，让我可以按预算和需求比较。",
    story: [
      "A friend had a great hair transplant result in China, but his travel and language difficulties made me hesitate. Sino Aesthetics introduced me to several established clinic groups, so I could compare options by budget and priorities.",
    ...
    storyZh: [
      "朋友在中国做植发的效果很好，但他遇到的出行和语言问题让我一直犹豫。Sino Aesthetics 推荐了几家成熟的连锁植发机构，让我可以按预算和需求比较。",
  ...
  },
  {
    ...
    story: [
      "I love the natural, refined look of Korean cosmetic medicine, but I assumed Sino Aesthetics only worked with doctors in China. They matched me with a Korean doctor whose aesthetic approach felt right and booked him two months ahead during his China visit.",
    ...
    storyZh: [
      "我喜欢韩式医美自然精致的风格，但原以为 Sino Aesthetics 只对接中国医生。他们根据我的审美匹配了一位韩国医生，并提前两个月预约了医生来中国出诊的时间。",
  ...
  },
  {
    ...
    story: [
      "I had considered rhinoplasty for nearly five years but worried about choosing a surgeon and recovering abroad. After reviewing my photos, Sino Aesthetics provided two Shanghai options with costs, dates and similar cases within four days.",
    ...
    storyZh: [
      "我考虑鼻整形近五年，却一直担心在国外选择医生和恢复。Sino Aesthetics 根据我的照片，在四天内提供了两位上海医生的费用、档期和相似案例。",
  ...
  },
  {
    ...
    story: [
      "Comparing hair transplant clinics in Australia and Turkey was confusing. Sino Aesthetics arranged three online assessments and helped me choose a Beijing clinic that proposed 3,050 grafts using FUE.",
    ...
    storyZh: [
      "不同诊所的技术、毛囊数量和价格很难比较。Sino Aesthetics 安排了三次线上评估，最终帮我选择北京一家建议采用 FUE 移植 3,050 个毛囊单位的诊所。",
  ...
  },
  {
    ...
    story: [
      "I wanted a small, natural crease. Sino Aesthetics arranged a video consultation with a Korean surgeon visiting Hangzhou, and I used photos to explain exactly how subtle I wanted the result.",
    ...
    storyZh: [
      "我想要窄而自然的双眼皮。Sino Aesthetics 安排了与一位定期到杭州出诊的韩国医生视频面诊，我用照片清楚说明了理想效果。",
  ...
  },
  {
    ...
    procedureZh: "牙齿贴面",
    excerpt: "Sino Aesthetics planned my 12-day Shanghai trip around the full veneer process, from examination to final fitting.",
    excerptZh: "Sino Aesthetics 按十二天的上海行程，安排了从初诊到最终试戴的完整贴面流程。",
    story: [
      "After an old cycling injury, one front tooth had become darker and I stopped smiling widely in photos. Sino Aesthetics planned my 12-day Shanghai trip around the full veneer process, from examination to final fitting.",
    ...
    storyZh: [
      "骑行事故后，一颗门牙逐渐变暗，我开始避免在照片里大笑。Sino Aesthetics 按十二天的上海行程，安排了从初诊到最终试戴的完整贴面流程。",
  ...
  },
  {
    ...
    story: [
      "Years of poor sleep and business travel left me with under-eye bags, but I worried that surgery would change my expression. Sino Aesthetics arranged two Guangzhou consultations and helped me understand why lower blepharoplasty with limited fat repositioning suited me better than filler.",
    ...
    storyZh: [
      "长期睡眠不规律和频繁出差让我眼袋明显，但我担心手术改变表情。Sino Aesthetics 安排了广州两位医生面诊，帮助我理解为什么下眼睑手术加少量脂肪调整比填充更适合。",
  ...
  },
  {
    ...
    story: [
      "I contacted Sino Aesthetics about pigmentation that had darkened after pregnancy. Instead of the laser I expected, the dermatologist recommended a gentler three-month plan with one clinic treatment, sunscreen and a prescription routine for home.",
