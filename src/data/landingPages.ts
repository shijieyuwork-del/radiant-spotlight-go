...
const CHINA_CITY_SLUGS = new Set(CITIES.map((city) => city.slug));

/** Only publish procedure landing pages for destinations currently offered in China. */
export const LANDING_PAGES = ALL_LANDING_PAGES.filter((page) => CHINA_CITY_SLUGS.has(page.citySlug));
