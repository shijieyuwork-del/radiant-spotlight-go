...
export const TIKTOK_CASES: TikTokItem[] = [
  {
    ...
    clinic: { en: "Beijing Yestar Hospital · Dr. Wang Xiaolin", zh: "北京艺星医院 · 王晓琳主任" },
