...
import guangzhouImg from "@/assets/city-guangzhou.webp";
...
export type City = {
  ...
  hospitals: { zh: string; en: string; areaZh: string; areaEn: string; img?: string; imageCredit?: string; imageSourceUrl?: string; imageLicense?: string }[];
  /** Travel essentials */
