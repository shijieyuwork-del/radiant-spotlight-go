...
export const DEMO_CHINA_DOCTORS: DemoChinaDoctor[] = [
  ...
  { id: "demo-zhou", name: "Dr. Zhou An", title: "Facial Rejuvenation Surgeon", hospital: "Sample Beijing Medical Center", city: "Beijing", specialties: ["Facelift", "Neck Lift", "Facial Fat Grafting"], bio: "Fictional sample profile for previewing specialties, consultation booking and expert-linked diaries.", photo: portrait2, demo: true },
  ...
  { id: "demo-xu", name: "Dr. Xu Ning", title: "Body Contouring Surgeon", hospital: "Sample Hangzhou Medical Center", city: "Hangzhou", specialties: ["Liposuction", "Tummy Tuck", "Body Contouring"], bio: "Fictional sample profile used only to demonstrate the expert discovery experience.", photo: portrait4, demo: true },
