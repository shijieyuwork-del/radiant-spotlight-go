...
export const DOCTORS: Doctor[] = [
  {
    ...
    bioEn:
      "Kim has practiced in Gangnam, Seoul for 18 years, specializing in Asian blepharoplasty, rhinoplasty and facial contouring. He has operated on performers and international patients, favoring natural, ageless and reversible outcomes.",
  ...
  {
    id: "park-sooyoung",
    zh: "朴秀荣 院长", en: "Park Soo-young · Director",
    ...
    bioEn:
      "Park has spent 22 years on SMAS facelift and neck rejuvenation. She is known for durable, natural lifts through minimal incisions and was among the first Korean surgeons to combine fat grafting with facelift.",
    ...
    awardsZh: ["2021 韩国整形外科优秀专家奖", "BK 面部年轻化中心 主任"],
  ...
  {
    id: "somchai-viriya",
    zh: "宋猜 维里亚 主任专家", en: "Somchai Viriya · Chief Expert",
    ...
    bioZh:
      "宋猜专家在曼谷康民国际医院执业 19 年，是泰国最早获得 Motiva 全球认证的专家之一，擅长隆胸、吸脂与 BBL 的组合塑形，服务大量欧美与亚洲国际患者。",
    bioEn:
      "Somchai has practiced at Bumrungrad International Hospital for 19 years. He was among Thailand's first Motiva Global Certified surgeons and specializes in combined breast, liposuction and BBL body makeovers for international patients.",
    ...
    awardsZh: ["Motiva 全球认证专家", "泰国美容整形外科学会 理事"],
  ...
  {
    id: "tanaka-yuki",
    zh: "田中 由纪 院长", en: "Tanaka Yuki · Director",
    ...
    bioEn:
      "Tanaka has focused on Japanese natural aesthetics for 16 years. She excels in minimally invasive blepharoplasty, fat grafting and subtle nasal refinement, favoring results that don't look operated on.",
    ...
    awardsZh: ["JSAPS 优秀专家奖 2020", "高须诊所 银座院 院长"],
  ...
  {
    id: "lim-weijie",
    zh: "林伟杰 顾问专家", en: "Lim Wei Jie · Consultant Expert",
    ...
    bioZh:
      "林伟杰专家是新加坡私立医院资深整形外科顾问，擅长高安全标准的面部拉皮、隆胸与产后腹壁修复，服务大量东南亚与国际医疗旅客。",
    bioEn:
      "Lim is a senior consultant plastic surgeon in Singapore's private hospital sector. He specializes in high-safety facelift, breast augmentation and post-pregnancy tummy repair for regional and international medical travelers.",
  ...
  {
    id: "li-wenzhi",
    zh: "李文志 主任专家", en: "Li Wenzhi · Chief Expert",
    ...
    bioEn:
      "Li specializes in periorbital and nasal surgery with 22 years of experience and 8,200+ procedures. He is sought after by international and returning clients for naturalistic results that respect deep-tissue anatomy.",
    ...
    awardsZh: ["新氧 2023 年度鼻综合金奖", "上海市整形外科优秀中青年专家"],
