...
type CompanyPageLayoutProps = { children: React.ReactNode; description: string; eyebrow: string; icon: LucideIcon; path: string; title: string };
      ...
      <main>
        <section className="border-b border-border/60 bg-gradient-hero/70">
          <div className="container py-10 md:py-16">
            <Link to="/" className="inline-flex items-center gap-2 text-sm font-semibold text-muted-foreground transition-colors hover:text-foreground"><ArrowLeft className="size-4" /> Back to home</Link>
