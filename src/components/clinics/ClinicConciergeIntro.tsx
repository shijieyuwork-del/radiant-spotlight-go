...
const COPY: Record<AsiaLang, ConciergeCopy> = {
  ...
  zh: {
    ...
    body: "告诉我们你正在考虑的项目。CeladonChina 将协助你比较合适的医院和诊所，并协调机构对接、术前问诊、预约及赴华行程。整个过程由同一支专属团队跟进，所有医疗费用由你直接支付给最终选择的医疗机构。",
  ...
  ru: {
    ...
    body: "Расскажите, что вы рассматриваете. CeladonChina поможет сравнить подходящие больницы и клиники, организует знакомство, консультации и запись, а также поддержит вас во время поездки в Китай. Всё это ведёт одна выделенная команда. Медицинские услуги вы оплачиваете напрямую выбранному учреждению.",
  ...
  th: {
    ...
    body: "บอกเราว่าคุณกำลังพิจารณาการรักษาแบบใด CeladonChina ช่วยคุณเปรียบเทียบโรงพยาบาลและคลินิกที่เหมาะสม ประสานการแนะนำ การปรึกษา และการนัดหมาย พร้อมดูแลการเดินทางในจีนผ่านทีมเฉพาะทีมเดียว คุณชำระค่ารักษาพยาบาลทั้งหมดโดยตรงให้ผู้ให้บริการที่เลือก",
  ...
  vi: {
    ...
    body: "Hãy cho chúng tôi biết phương án điều trị bạn đang cân nhắc. CeladonChina giúp bạn so sánh các bệnh viện và phòng khám phù hợp, điều phối giới thiệu, tư vấn và lịch hẹn, đồng thời hỗ trợ hành trình của bạn tại Trung Quốc thông qua một đội ngũ chuyên trách. Bạn thanh toán toàn bộ chi phí y tế trực tiếp cho cơ sở đã chọn.",
  ...
  ko: {
    ...
    body: "고려 중인 진료를 알려 주세요. CeladonChina가 적합한 병원과 클리닉을 비교할 수 있도록 돕고, 기관 연결과 상담, 예약을 조율하며 전담팀 하나가 중국에서의 여정을 지원합니다. 모든 의료비는 선택한 의료기관에 직접 결제합니다.",
  ...
  ja: {
    ...
    body: "検討中の施術をお聞かせください。CeladonChinaが適した病院やクリニックの比較をお手伝いし、医療機関のご紹介、相談、予約を調整します。中国でのご滞在も一つの専任チームがサポートします。医療費はすべて、選択した医療機関へ直接お支払いいただきます。",
